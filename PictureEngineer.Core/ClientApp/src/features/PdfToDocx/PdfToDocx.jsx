...
import { fetchPdfConvertClearData } from "../../redux/actions/PDF/PdfConvertAction";
...
export default function Service() {
    ...
    useEffect(function () {
        dispatch(getDetailService("chuyen-doi-pdf-sang-docx"));
        dispatch(fetchPdfConvertClearData());
    }, [dispatch])
